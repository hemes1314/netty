package org.wubin.sample.netty.netty5heart.copy;
...
public class Server {
	...
	public static void main(String[] args) {
		...
		try {
			...
			bootstrap.childOption(ChannelOption.SO_KEEPALIVE, true);// socketChannel的设置，维持连接活跃，清除死链接，长时间没有读写就关闭连接，默认两小时
			...
			// 等待服务端关闭
			future.channel().closeFuture().sync();// sync 阻塞
